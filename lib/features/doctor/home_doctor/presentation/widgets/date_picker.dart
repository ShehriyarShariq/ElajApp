    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          bool isUnselectedCurrentDate =
              !isSelected && _compareDate(date, DateTime.now());

          // Return the Date Widget
          return DateWidget(
            date: date,
            monthTextStyle: isSelected || isUnselectedCurrentDate
                ? selectedMonthStyle
                : widget.monthTextStyle,
            dateTextStyle: isSelected || isUnselectedCurrentDate
                ? selectedDateStyle
                : widget.dateTextStyle,
            dayTextStyle: isSelected || isUnselectedCurrentDate
                ? selectedDayStyle
                : widget.dayTextStyle,
            width: widget.width,
